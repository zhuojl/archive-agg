...
import com.zhuojl.share.compose.annotation.MapReduce;
...
public interface OrderService extends ComposeAble<OrderService.OrderServiceComposeParam> {
     ...
     */
    @MethodComposeConfig(paramHandler = SIMPLE_HANDLER)
     ...
     */
    @MethodComposeConfig(paramHandler = ORDER_QUERY_HANDLER)
